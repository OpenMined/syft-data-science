...
from syft_display_utils.jupyter.icons import Icon
from syft_display_utils.jupyter.table_utils import (
    TABLE_INDEX_KEY,
    format_table_data,
    prepare_table_data,
)
from syft_display_utils.resources import load_css, load_js
...
jinja_env = jinja2.Environment(
    loader=jinja2.PackageLoader("syft_display_utils", "assets/jinja")
)  # nosec
